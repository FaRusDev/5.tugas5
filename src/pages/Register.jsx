      ...
      <div className="flex justify-center items-center pt-30 pb-15 overflow-auto">
        ...
        >
          ...
          <form action="#" className="flex flex-col gap-y-6">
            ...
            <div className="htmlForm-group flex flex-col gap-y-1">
              <label htmlFor="phone" className="flex flex-row gap-x-2">
                <p className="font-DMSans text-gray-500 leading-tight text-sm font-normal tracking-wide">
                  No. Hp
                </p>
                <span>
              ...
              <div className="flex flex-row justify-between gap-x-3">
                <div className="flex flex-row">
                  <div
                    id="flag"
                    className="bg-gray-200 h-12 px-3 rounded-l-md flex items-center"
                  >
                    <svg
                      width="24"
                      height="24"
                  ...
                  <div
                    id="flag"
                    className="h-12 border-gray-200 border px-3 rounded-r-md flex items-center flex-row gap-x-2"
                  >
                    <p className="text-sm font-DMSans">+62</p>
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clipPath="url(#clip0_12865_458)">
                        <path
            ...
            <div className="htmlForm-group flex flex-col gap-y-1">
              <label htmlFor="confirm" className="flex flex-row gap-x-2">
                <p className="font-DMSans text-gray-500 leading-tight text-sm font-normal tracking-wide">
